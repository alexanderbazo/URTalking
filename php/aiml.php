<?php
	...
	function ask_aiml($request, $aiml_file)
	{
		...
		$result = shell_exec('../python/ask.py -q "'.$request.'" -a "../python/aiml/'.$aiml_file.'" -s '.session_id().' -d "../python/dict/" -c "../python/lists/top10k_de.list" -l "../python/stopwords/german.stop" 2>&1');
